 ...
 */
public class InteractiveIIJ2NodeDialog<T extends RealType<T> & NativeType<T>> extends DataAwareDefaultNodeSettingsPane {

    private static final String APPEND_DEFAULT = "_Label";

    private DialogComponentIJ2Interactive<T> m_interactiveIJ2Dialog;
    ...
    public InteractiveIIJ2NodeDialog() {
        super();
        ...
        m_smColCreationMode.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(final ChangeEvent e) {
                if (m_smColCreationMode.getStringValue().equals(ValueToCellNodeModel.COL_CREATION_MODES[1])) {
                    ...
                    if (m_smColumnSuffix.getStringValue().equals(APPEND_DEFAULT)) {
    ...
    public void loadAdditionalSettingsFrom(final NodeSettingsRO settings, final PortObject[] input)
        ...
        DataTable filteredTable = new FilterColumnTable(inputTable, ImgPlusValue.class);
        m_interactiveIJ2Dialog.updateDataTable(filteredTable);
    }
